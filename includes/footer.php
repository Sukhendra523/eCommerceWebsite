...
if (isset($_POST['subscribe'])) {
	...
	if (!$result) {
		...
		$success_msg="Thank You subscribing Us!";
                           ...
                           $headers = "From: team.imaginer@gmail.com\n"; 
                           $headers .= "Reply-To: team.imaginer@gmail.com";	
        ...
        <ul>
                    <?php 
                        ...
                        while($row_p_cats=mysqli_fetch_array($run_p_cats)){
                            ...
                            $urlPcattitle = urlencode($p_cat_title);
                            
                            echo "
                            
                                <li>
                                
                                    <a href='shop.php?proCat=$urlPcattitle'>
                        ...
                        while($row=mysqli_fetch_array($run)){
                            ...
                            echo "
                                ...
                                <li>
                                    ...
                                    <a href='shop.php?subCat=$urlTitle'>
