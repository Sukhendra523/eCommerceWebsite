...
define('PAYTM_MERCHANT_KEY', 'j21%Txznc8YI_Knn'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'YiaiKd95513479096386'); //Change this constant's value with MID (Merchant ID) received from Paytm.
